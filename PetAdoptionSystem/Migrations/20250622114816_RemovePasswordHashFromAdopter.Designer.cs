...
namespace PetAdoptionSystem.Migrations
{
    ...
    [Migration("20250622114816_RemovePasswordHashFromAdopter")]
    partial class RemovePasswordHashFromAdopter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetAdoptionSystem.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PetAdoptionSystem.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PetAdoptionSystem.Models.ApplicationUser", b =>
                {
                    b.HasOne("PetAdoptionSystem.Models.Adopter", null)
                        .WithMany()
                        .HasForeignKey("AdopterId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
